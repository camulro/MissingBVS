...
#' through Bayes Factor Averaging (BFA) for linear models in the presence of missing
#' data.
#'
...
#' and must be nested in the rest. In order to implement BFA, \code{\link[MissingBVS]{missingBtest.lm}}
