...
#' \code{\link[MissingBVS]{missingGibbsBVS.lm}}
#' @references
#'
...
#'
#' @keywords package
#' @importFrom stats as.formula lm lm.fit glm glm.fit .lm.fit model.frame
#'   model.matrix terms glm.control binomial na.omit var
...
#' # BIC approximation for BF by default
...
#' @name diabetes
#' @docType data
#' @format A data frame with 768 entries and 9 variables.
#' \describe{
#' \item{Pregnancies}{Number of times pregnant}
#' \item{Glucose}{Plasma glucose concentration from a glucose tolerance test}
...
#' \item{BMI}{Body mass index (kg of weight / m^2 of height)}
#' \item{DiabetesPedigreeFunction}{Diabetes Pedigree Function}
#' \item{Age}{Age in years}
#' \item{Outcome}{Diabetes (1) or not (0)}
#' }
#'
...
#' of diabetes mellitus. In Proceedings of the Symposium on Computer Applications
...
#' Data were taken from \pkg{BayesVarSel}.
#'
#'
#' @name OBICE
#' @docType data
...
#'
#' @examples
#' ## Obtain the amputed version from the complete simulation:
#' #data(simulation)
#' #set.seed(1)
...
#' #aux <- mice::ampute(simulation[, -1], prop = 0.65, patterns = my.patterns,
#' #  weights = weights, mech = "MAR")
#' #ampsimulation <- data.frame(y = simulation[, 1], aux$amp)
#'
#' data(ampsimulation)
#'
"ampsimul"
